...
### Added
- `statistical-analysis-tools` skill covering Shannon entropy, chi-square goodness-of-fit, Poisson distribution simulation, Martingale processes, logistic map chaos theory, and hypothesis testing
